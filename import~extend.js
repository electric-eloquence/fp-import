  ...
  constructor(file, type, engine) {
    ...
    switch (type) {
      case 'assets':
        ...
        this.data.assets_ext = utils.extCheck(this.data.assets_ext);
        break;
      ...
      case 'scripts':
        ...
        this.data.scripts_ext = utils.extCheck(this.data.scripts_ext);
        break;
      ...
      case 'styles':
        ...
        this.data.styles_ext = utils.extCheck(this.data.styles_ext);
        break;
      ...
      case 'templates':
        ...
        this.data.templates_ext = utils.extCheck(this.data.templates_ext);
